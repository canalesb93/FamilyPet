...
@IBDesignable class ADVSegmentedControl: UIControl {
    ...
    var items: [String] = ["Dog", "Cat", "Other"] {
        didSet {
            setupLabels()
        }
    }
    ...
    @IBInspectable var selectedLabelColor : UIColor = UIColor(netHex: 0xF7F7FF) {
        didSet {
            setSelectedColors()
        }
    }
    
    @IBInspectable var unselectedLabelColor : UIColor = UIColor(netHex: 0x4C4C4F) {
        didSet {
            setSelectedColors()
        }
    }
    
    @IBInspectable var thumbColor : UIColor = UIColor(netHex: 0x4C4C4F) {
        didSet {
            setSelectedColors()
        }
    }
    
    @IBInspectable var borderColor : UIColor = UIColor(netHex: 0x4C4C4F) {
        didSet {
    ...
    func setupView(){
        ...
        layer.borderColor = UIColor(netHex: 0x4C4C4F).CGColor
        layer.borderWidth = 2
